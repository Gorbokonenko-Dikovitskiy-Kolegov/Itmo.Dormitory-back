        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Information_Title = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: true),
                    Information_Description = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ISUNumber_Value = table.Column<string>(type: "text", nullable: true),
                    RoomNumber_Value = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Applications_Residents_ResidentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_ResidentId",
                table: "Applications",
                column: "ResidentId");
