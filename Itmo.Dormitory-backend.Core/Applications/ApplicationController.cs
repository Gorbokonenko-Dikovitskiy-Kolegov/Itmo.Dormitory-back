using Itmo.Dormitory_backend.Core.Applications.Commands;
using Itmo.Dormitory_backend.Core.Applications.Queries;
using MediatR;
...
namespace Itmo.Dormitory_backend.Core.Applications
{
    [ApiController]
